<template>
    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg navbar-dark justify-content-between">
           <RouterLink class="navbar-brand" to="/"><img src="../assets/images/tavuelogo.png" alt="Votre Logo" class="navbar-brand" style="max-height: 50px;">
         </RouterLink>
          <button
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <RouterLink class="nav-link header-text-bold" to="/">Accueil</RouterLink>
              </li>
              <li class="nav-item">
